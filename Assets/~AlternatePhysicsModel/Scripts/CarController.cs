...
public class CarController : MonoBehaviour {
	...
	void OnGUI ()
	{
		GUI.Label (new Rect(0,60,100,200),"km/h: "+(int)GetComponent<Rigidbody>().velocity.magnitude * 3.6f);
		tractionControl = GUI.Toggle(new Rect(0,80,300,20), tractionControl, "Traction Control");
	}
}
